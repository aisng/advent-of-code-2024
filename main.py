...
sample_data_p1 = """1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet"""

real_data = """twovgtprdzcjjzkq3ffsbcblnpq
...
def main() -> None:
    print(get_calibration_value(real_data))
    print(get_calibration_value_p2(real_data))
